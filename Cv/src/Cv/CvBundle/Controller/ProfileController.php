...
use Cv\CvBundle\Entity\Profile;
use Cv\CvBundle\Form\ProfileType;
use Cv\CvBundle\Entity\Image;
...
class ProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CvCvBundle:Profile')->findAll();
     ...
     * @Method("POST")
     * @Template("CvCvBundle:Profile:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CvCvBundle:Profile')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CvCvBundle:Profile:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ...
            ->setMethod('DELETE')
            ->add('submit', 'submit', array('label' => 'Suprimmer', 'attr' => array('class' => 'btn btn-danger')))
            ->getForm()
        ;
    }
}
