...
use Cv\CvBundle\Entity\Langue;
use Cv\CvBundle\Form\LangueType;
...
class LangueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CvCvBundle:Langue')->findAll();
     ...
     * @Method("POST")
     * @Template("CvCvBundle:Langue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CvCvBundle:Langue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CvCvBundle:Langue:edit.html.twig")
     */
