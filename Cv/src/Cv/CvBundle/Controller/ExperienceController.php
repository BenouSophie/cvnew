...
use Cv\CvBundle\Entity\Experience;
use Cv\CvBundle\Form\ExperienceType;
...
class ExperienceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CvCvBundle:Experience')->findAll();
     ...
     * @Method("POST")
     * @Template("CvCvBundle:Experience:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CvCvBundle:Experience')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CvCvBundle:Experience:edit.html.twig")
     */
