...
use Cv\CvBundle\Entity\Competence;
use Cv\CvBundle\Form\CompetenceType;
...
class CompetenceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CvCvBundle:Competence')->findAll();
     ...
     * @Method("POST")
     * @Template("CvCvBundle:Competence:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CvCvBundle:Competence')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CvCvBundle:Competence:edit.html.twig")
     */
