...
use Cv\CvBundle\Entity\Projet;
use Cv\CvBundle\Form\ProjetType;
...
class ProjetController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CvCvBundle:Projet')->findAll();
     ...
     * @Method("POST")
     * @Template("CvCvBundle:Projet:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CvCvBundle:Projet')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CvCvBundle:Projet:edit.html.twig")
     */
